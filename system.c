...
static void Init_GPIO(void)
{
    ...
    /* */
    ANSELA = 0;  // Disable analogue inputs on port A
    ANSELB = 0;  // Disable analogue inputs on port B
    ANSELC = 0;  // Disable analogue inputs on port C
    ANSELD = 0;  // Disable analogue inputs on port D
    ANSELE = 0;  // Disable analogue inputs on port E
    ANSELG = 0;  // Disable analogue inputs on port G

    /*** Output Pins Required ***/
    /* Ext_WDT - RB0*/
    /* Charge_Enable - RB4*/
    /* Battery_Enable - RB5*/
